...
// RequestOption is an option for the requests made by the hetzner API Client
...
// WithAPIToken returns a RequestOption that specifies a API Token
// to be used as the basis for authentication.
func WithAPIToken(key string) RequestOption {
	return func(r *requestconfig.RequestConfig) error {
		r.APIToken = key
...
func WithEnvironmentProduction() RequestOption {
	return WithBaseURL("https://api.hetzner.cloud/v1/")
}
