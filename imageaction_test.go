...
func TestImageActionGet(t *testing.T) {
	...
	_, err := client.Images.Actions.Get(
		context.TODO(),
		int64(0),
		int64(0),
	)
...
func TestImageActionListWithOptionalParams(t *testing.T) {
	if !testutil.CheckTestServer(t) {
		return
	}
	client := hetzner.NewClient(
	...
	_, err := client.Images.Actions.List(
		context.TODO(),
		int64(0),
		hetzner.ImageActionListParams{
...
func TestImageActionChangeProtectionWithOptionalParams(t *testing.T) {
	if !testutil.CheckTestServer(t) {
		return
	}
	client := hetzner.NewClient(
	...
	_, err := client.Images.Actions.ChangeProtection(
		context.TODO(),
		int64(0),
		hetzner.ImageActionChangeProtectionParams{
