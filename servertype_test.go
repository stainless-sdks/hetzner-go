...
func TestServerTypeGet(t *testing.T) {
	...
	_, err := client.ServerTypes.Get(context.TODO(), int64(0))
	if err != nil {
...
func TestServerTypeListWithOptionalParams(t *testing.T) {
	if !testutil.CheckTestServer(t) {
		return
	}
	client := hetzner.NewClient(
	...
	_, err := client.ServerTypes.List(context.TODO(), hetzner.ServerTypeListParams{
